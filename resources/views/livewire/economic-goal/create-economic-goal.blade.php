<form class="bg-white dark:bg-gray-100 overflow-hidden shadow-sm p-6 rounded-lg w-full max-w-4xl" 
    wire:submit.prevent='createEconomicGoal'>
    <h1 class="text-2xl font-bold text-center mb-10">{{ __('Create Economic Goal') }}</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div class="mb-4">
                ...
                <select 
                    ...
                    <option value="6">{{__('Greater than or equal to')}}</option>
                    <option value="7">{{__('Less than or equal to')}}</option>
                </select>
